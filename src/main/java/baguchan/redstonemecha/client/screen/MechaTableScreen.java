...
@OnlyIn(Dist.CLIENT)
public class MechaTableScreen extends ContainerScreen<MechaTableContainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(RedstoneMechaCore.MODID,"textures/gui/container/mecha_table.png");
    private float sliderProgress;
    private boolean isRecipeClicked;
    private int recipeIndexOffset;
    private boolean hasInput;

    public MechaTableScreen(MechaTableContainer containerIn, PlayerInventory playerInv, ITextComponent title) {
    ...
    private void func_214142_b(int p_214142_1_, int p_214142_2_, int p_214142_3_) {
        ...
        List<MechaTableRecipe> list = this.container.getRecipeList();
